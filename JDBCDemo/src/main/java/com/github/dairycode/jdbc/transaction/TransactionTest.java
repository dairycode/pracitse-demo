package com.github.dairycode.jdbc.transaction;

import com.github.dairycode.jdbc.bean.User;
 ...
 *      > 一组逻辑操作单元: 一个或多个DML操作
 * 2.事务处理的原则: 保证多个事务都作为一个工作单元来执行,即使出现了故障,都不能改变这种执行方式
 *   当在一个事务中执行多个操作时,要么所有的事务都被提交,那么这些修改就永久保存

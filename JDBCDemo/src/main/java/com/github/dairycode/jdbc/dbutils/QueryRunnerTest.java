package com.github.dairycode.jdbc.dbutils;

import com.github.dairycode.jdbc.bean.Customer;
import com.github.dairycode.jdbc.pool.util.JDBCUtils;
...
/**
 * commons-dbutils: Apache组织提供的一个开源JDBC工具类,封装了针对数据库的增删改查操作
 */
public class QueryRunnerTest {
    ...
    public void testInsert() {
        ...
        try {
            ...
            int insertCount = runner.update(conn, sql, "蔡徐坤", "caixunkun@126.com", "1997-09-08");
    ...
    public void testQuery2() {
        ...
        try {
            ...
            List<Customer> list = runner.query(conn, sql, handler, 8);
    ...
    public void testQuery4() {
        ...
        try {
            ...
            List<Map<String, Object>> list = runner.query(conn, sql, handler, 8);
